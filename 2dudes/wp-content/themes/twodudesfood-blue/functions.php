...
function aevidi_build_taxonomies() {
    register_taxonomy( 'atmosphere', array('review'), array( 'hierarchical' => true, 'label' => 'Review Atmospheres', "singular_label" => "Atmosphere", 'query_var' => true, 'rewrite' => true ) );
    register_taxonomy( 'cuisine', array('review'), array( 'hierarchical' => true, 'label' => 'Review Cuisines', "singular_label" => "Cuisine", 'query_var' => true, 'rewrite' => true ) );
 ...
 */
function admin_init(){
  add_meta_box("review_Information", "Additional Information about the eating establishment", "review_feedback", "review", "normal", "high");
}
...
function review_feedback(){
  ...
  ?>
  <p><label>Street Address (Number and Name):</label><br />
  <input class="newtag form-input-tip" type="text" style="width:100%;height:24px;" name="street"><?php echo $street; ?></p>
  <p><label>Phone Number:</label><br />
  <input class="newtag form-input-tip" type="text" style="width:100%;height:24px;" name="phone"><?php echo $phone; ?></p>
  <p><label>Feedback (Summarize your review)</label><br />
  <textarea rows="5" style="width:100%;resize:none;" name="summary"><?php echo $summary; ?></textarea></p>
  <?php
}
...
function review_save_details(){
  ...
  update_post_meta($post->ID, "steet", $_POST["street"]);
