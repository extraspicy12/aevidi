$(document).ready(function() {
  ...
  function adjustMenu() {
      ...
      if(w < 757) {
          ...
          if (!search.hasClass("mobile")) {
            ...
            bottom.css("backgroundColor", "#3c8eda");
            search.css("display", "block");
          }
      } else {
          if (search.hasClass("mobile")) {
            search.removeClass("mobile");
            bottom.css("backgroundColor", "#81bef7");
  ...
  $(".search-toggle-button").mouseover(function(){
    if ($(".search-toggle").css("display") == "none")
      $(".search-toggle-button, .bottom").stop().animate({backgroundColor: '#aed8ff'}, 200);
  });
  $(".search-toggle-button").mouseout(function(){
    if ($(".search-toggle").css("display") == "none")
      $(".search-toggle-button, .bottom").stop().animate({backgroundColor: '#81bef7'}, 200);
  });
  $(".search-toggle-button").click(function(){
    if ($(".search-toggle").css("display") == "none") {
      $(".search-toggle").stop().slideToggle(200);
        $(".search-toggle-button, .bottom").animate({backgroundColor: '#aed8ff'}, 200);
    } else {
      $(".search-toggle").stop().slideToggle(200);
        $(".search-toggle-button, .bottom").animate({backgroundColor: '#81bef7'}, 200);
    }
  });
