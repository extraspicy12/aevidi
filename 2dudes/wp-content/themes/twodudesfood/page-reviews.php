            ...
            <div class="row" id="sorting-module">
              <div class="medium-3 columns" id="sort-by-categories">
                ...
                <ul id="sorting-categories">
                  <li><a href="#" value="category" id="category-key">Category</a></li>
              ...
              <div class="medium-9 columns" id="sort-by-values">
                <ul class="sort-by-x" id="sort-by-category">
                  <li><a href="#" value="a">Category</a></li>
                  <li><a href="#" value="b">Category</a></li>
                  <li><a href="#" value="c">Category</a></li>
                  <li><a href="#" value="d">Category</a></li>
                </ul>
