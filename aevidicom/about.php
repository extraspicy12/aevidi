		...
		<div class="container">
			<div class="large-12 small-centered columns" id="about-top-band">
				<div class="large-8 columns no-pad">
					...
					<p>aeVidi, LLC is a small, start-up web design and development company. We aim to provide small businesses and non-profits the service of having a
				...
				<div class="large-4 columns white-box">
					...
					<div class="row flat small-centered" id="website-box">
		...
		<div class="large-12 small-centered columns no-pad">
			<div class="container">
				<div class="large-12 columns small-centered">
					<h4 class="fancy-header light">Our Process</h4>
					<div class="row large-12 process-block flat">
						<div class="large-3 columns h-centered"> <img src="img/people.png"/> </div>
							...
							<div class="row">
								<div class="large-11 columns process-content">
									<p>By using the nifty contact form we have at the bottom of every page, you can send us an outline of everything you would
										...
										a price is agreed upon, then we will proceed to the next step in the process.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="row large-12 process-block flat">
						<div class="large-3 columns h-centered"> <img src="img/painting.png"/> </div>
						<div class="large-9 columns">
							<div class="row">
					...
					<div class="row large-12 process-block flat">
						<div class="large-3 columns h-centered"> <img src="img/idea.png"/> </div>
						<div class="large-9 columns">
							<div class="row">
							...
							<div class="row">
								<div class="large-11 columns process-content">
									<p>This is the point in the process where we finally get your website online. We will work with you to purchase a webhost
										...
										and upload content that you create.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="large-12 columns small-centered">
					...
					<div class="row">
						<div class="large-12 columns">
							...
							<p>Shabai has been doing graphic design and front-end development since 2007, and has freelanced for a few clients including Billeater and theBarBlogger. As the design specialist, he oversees the mockup process from beginning to end, and ensures the final product is not only a marvel to look at, but fitting with the client's needs. In his spare time, he enjoys playing Minecraft and adding to his Flickr photostream.</p>
						</div>
					</div>
				</div>
			</div>
